package com.tarlanus.facerecognitionv2.presentation.register.screen
...
import com.tarlanus.facerecognitionv2.presentation.register.viewmodel.ViewModelRegister
...
fun RegisterScreen(
    ...
    val tf = viewModelRegister.tf.collectAsStateWithLifecycle()
            ...
            when(state) {
                ...
                is RegisterState.IMAGESELECTED -> {
                    Column(modifier = Modifier.height(350.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                        ...
                        OutlinedTextField(
                            tf.value, onValueChange = {viewModelRegister.setTf(it)}, singleLine = true,
                            label = {
                        ...
                        Button(
                            ...
                            onClick = {
                                viewModelRegister.startRegisterImage(state.path)
