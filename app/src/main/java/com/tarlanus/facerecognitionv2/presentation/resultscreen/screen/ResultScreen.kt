package com.tarlanus.facerecognitionv2.presentation.resultscreen.screen
...
import com.tarlanus.facerecognitionv2.presentation.camera.screen.CameraScreen
import com.tarlanus.facerecognitionv2.presentation.gallery.screen.GalleryScreen
import com.tarlanus.facerecognitionv2.presentation.resultscreen.state.ResultState
import com.tarlanus.facerecognitionv2.presentation.resultscreen.viewmodel.ViewModelResult
import com.tarlanus.facerecognitionv2.ui.theme.Accent

@Composable
fun ResultScreen(userDetails: UserDetails, viewModelResult: ViewModelResult = hiltViewModel()) {
    ...
    LaunchedEffect(Unit) {
        viewModelResult.setImageLoaded(userDetails.imagePath, userDetails.candidateName)
    }
            ...
            when(state) {
                ...
                is ResultState.IMAGELOADED -> {
                    Column(modifier = Modifier.height(350.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                        ...
                        Text(state.name, fontSize = 18.sp, textAlign = TextAlign.Center, modifier = Modifier.height(150.dp).padding(horizontal = 10.dp))
...
fun PreviewResultScreen() {
    val details = UserDetails(id = 0, candidateName = "", imagePath = "")
